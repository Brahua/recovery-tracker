...
- [ ] A1. Store de operaciones en curso
...
- [ ] A3. Toasts + barra de progreso montados globalmente
...
- [ ] B2. Páginas sin `AppShell` y shell con tab activo por `usePathname`
...
- [ ] B3. Racha fresca después de guardar
...
- [ ] C3. Pending de formularios `useActionState`
...
- [ ] D3. Sesión y cierre (acciones 1–2)
